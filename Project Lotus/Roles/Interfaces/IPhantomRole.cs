...
/// <summary>
/// A "Phantom" role is any role that should be treated as "not really existing" in the game.
/// Currently this is only applicable to the <see cref="Roles.RoleGroups.Neutral.Taskrunner"/> role. But can be used in any class
